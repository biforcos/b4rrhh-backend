...
@Entity
@Table(name = "extra_payment_regime", schema = "employee")
public class ExtraPaymentRegimeEntity {
    ...
    @Column(name = "extra_payment_regime_number", nullable = false)
    private Integer extraPaymentRegimeNumber;
    ...
    public void setExtraPaymentRegimeNumber(Integer extraPaymentRegimeNumber) {
